...
TriggerRegisterCommonCommandEventBJ = lambda trig, order: None
...
SetThematicMusicVolumeBJ = lambda volumePercent: None
...
CreateCommonCommandButtonEffectBJ = lambda order: None
